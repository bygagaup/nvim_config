...
map("n", "t", "<Plug>Translate", { silent = true })
map("v", "t", "<Plug>TranslateV", { silent = true })
-- Заменить текст переводом
map("n", "r", "<Plug>TranslateR", { silent = true })
map("v", "r", "<Plug>TranslateRV", { silent = true })
-- Перевод текста из буфера обмена
map("n", "x", "<Plug>TranslateX", { silent = true })
-- fzf
